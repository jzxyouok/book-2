...
<div class="order_box">
	...
	<div class="fastway_list_box" style="padding-left: 20px;padding-bottom: 0px;">
		<ul class="fastway_list">
			<li><a href="<?=UrlService::buildNull();?>" style="padding-left: 0.1rem;"><span>支付金额：<?=$pay_order_info['pay_price'];?></span></a></li>
			<li><a href="<?=UrlService::buildNull();?>" style="padding-left: 0.1rem;"><span>支付备注：<?=$pay_order_info['note'];?></span></a></li>
		</ul>
	</div>
</div>
<div class="op_box">
