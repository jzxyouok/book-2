...
<div class="sort_box">
    <ul class="sort_list clearfix">
        <li>
            <a href="<?=UrlService::buildNull();?>" <?php if(  $search_conditions['sort_field'] == "default" ) :?> class="aon" <?php endif;?> data="default">
                <span>默认</span>
            </a>
        </li>
        <li>
            <a href="<?=UrlService::buildNull();?>" <?php if(  $search_conditions['sort_field'] == "month_count" ) :?> class="aon" <?php endif;?> data="month_count">
                <span>月销量
        ...
        <li>
            <a href="<?=UrlService::buildNull();?>" <?php if(  $search_conditions['sort_field'] == "view_count" ) :?> class="aon" <?php endif;?> data="view_count">
                <span>人气
        ...
        <li>
            <a href="<?=UrlService::buildNull();?>" <?php if(  $search_conditions['sort_field'] == "price" ) :?> class="aon" <?php endif;?> data="price">
                <span>价格
