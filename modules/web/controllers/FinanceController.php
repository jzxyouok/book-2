...
class FinanceController extends BaseController{
	...
	public function actionPay_info(){
		...
		$data_pay_order_info = [
			...
			'status_desc' => ConstantService::$pay_status_mapping[ $pay_order_info['status'] ],
			'status' => $pay_order_info['status'],
			'express_status_desc' => ConstantService::$express_status_mapping[ $pay_order_info['express_status'] ],
