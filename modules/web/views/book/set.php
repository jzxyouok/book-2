...
<div class="row mg-t20 set_wrap">
    <div class="col-lg-12">
        <h2 class="text-center">图书编辑或者添加</h2>
        <div class="form-horizontal m-t">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" placeholder="$160.00">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
                ...
                <div class="col-lg-2">
                    <div class="input-group">
                        <div class="input-group-addon">
                            <a class="disabled" href="<?=UrlService::buildNull();?>">
            ...
            <div class="form-group">
                <div class="col-lg-4 col-lg-offset-2">
                    <button class="btn btn-w-m btn-outline btn-primary">保存</button>
                </div>
            </div>
        </div>
    </div>
