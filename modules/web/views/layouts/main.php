	...
	<nav class="navbar-default navbar-static-side" role="navigation">
		<div class="sidebar-collapse">
			<ul class="nav metismenu" id="side-menu">
                ...
                <li class="market">
                    <a href="<?=UrlService::buildWebUrl("/market/index");?>"><i class="fa fa-share-alt fa-lg"></i> <span class="nav-label">营销渠道</span></a>
                </li>
                <li class="stat">
		...
		<div class="row border-bottom">
			<nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
				<div class="navbar-header">
					<a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="<?=UrlService::buildNull();?>"><i class="fa fa-bars"></i> </a>
				...
				<ul class="nav navbar-top-links navbar-right">
					...
					<li class="dropdown user_info">
						<a  class="dropdown-toggle" data-toggle="dropdown" href="<?=UrlService::buildNull();?>">
